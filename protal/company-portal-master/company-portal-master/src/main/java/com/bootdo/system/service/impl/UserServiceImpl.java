...
//    @Cacheable(value = "user",key = "#id")
    ...
    //新增用户
    @Override
    public int addUser(UserDO user) throws Exception {

        //TODO
        //校验输入规则
        UserDO userDO = userMapper.getByUsernameOrEmailOrMobile(
                user.getUsername(), user.getEmail(), user.getMobile());
        ...
        //注册时设置默认值，暂时不需要用户输入，后期管理员对这些值进行修改
        user.setStatus(1);
//        user.setDeptId(6L);
